    ...
    <div>
      ...
      <div className="flex gap-2 flex-col justify-between items-center">
        ...
        <div className="mt-2 w-full">
          <button
            onClick = { endRide }
            className="w-full flex justify-center text-lg bg-green-600 mt-1 text-white font-semibold p-2 rounded-lg"
          >
            Finish Ride
          </button>
          <p className=" ml-4 mt-10 text-xs"> 
